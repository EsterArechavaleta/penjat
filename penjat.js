...
const categoriaAnimales = ['PERRO', 'GATO', 'TORTUGA', 'ELEFANTE', 'PERIQUITO'];
const categoriaMediosTransporte = ['COCHE', 'AVION', 'BARCO', 'SUBMARINO', 'MOTO'];
const categoriaCapitales = ['PARIS', 'LONDRES', 'MADRID', 'WASHINGTON', 'LISBOA'];
const categoriaAlimentos = ['CHOCOLATE', 'CHORIZO', 'GALLETA', 'AZUCAR', 'HELADO'];
...
categoria.addEventListener('click', (e) => {
  if(e.target.value == 'animales') {
    eligePalabra(categoriaAnimales);
  }

  if(e.target.value == 'mtransporte') {
    eligePalabra(categoriaMediosTransporte);
  }

  if(e.target.value == 'capitales') {
    eligePalabra(categoriaCapitales);
  } 

  if(e.target.value == 'alimentos') {
    eligePalabra(categoriaAlimentos);
  }
});

inicio.addEventListener('click', iniciaJuego);
